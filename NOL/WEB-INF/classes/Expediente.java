...
public class Expediente extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<body>\r\n"
                ...
                + "        <div class='col-1'><a href='LoginAlumno'><img src='Flecha_atras.png' id='atras' width='30pt'/></a></div>\r\n"
                + "        <div class='col-10'><h1>Expediente de " + apellido_alumno + ", " + nombre_alumno + " (" + dni + ")</h1></div>\r\n"
                + "    </div>\r\n"
                + "    <div class='row'>\r\n"
                + "        <div><img class='fotos center' id='fotodni' src='img.png' alt='foto alumno' /></div>\r\n"
                + "    </div>"
                + "    <p class='xbootstrap'><b> Expediente: </b></p>\r\n");
        ...
        out.println("<div id='abajo'><p>Trabajo en grupo realizado por el grupo 3TI12_G2 en el curso DEW 2021/2022</p></div>");
        out.println("<script>"
